...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>From Left to Right: The catch screen, shown when a Hunter is near a Hunted Player; A win screen with a blue overlay, that exists the game with a countdown; A red lose screen</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>An example usage of the dependency array, using "count"</p></figcaption></figure>
