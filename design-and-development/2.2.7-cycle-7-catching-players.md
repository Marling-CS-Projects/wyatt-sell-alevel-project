...
<pre class="language-typescript"><code class="lang-typescript"><strong>// Adds catching and catcher relationships and sends a socket message
</strong><strong>// telling the catcher that they are now able to catch
...
// Removes catching and catcher relationsjips and sends a socket message
// telling the catcher they are no longer able to catch
unsetCatchable() {
  if (this.catching) {
...
```typescript
// Adds a catching field to the client user containing details of the player
...
![](<../.gitbook/assets/image (2) (1) (2).png>)![](<../.gitbook/assets/image (9) (2).png>)
