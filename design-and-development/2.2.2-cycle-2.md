...
Line 98 handles the core of socket interaction, and ensures that any socket requests are handled, and, if appropriate, new data is broadcasted to all other relevant sockets. This will likely need to be refactored at a later data, and moved into multiple files for&#x20;
