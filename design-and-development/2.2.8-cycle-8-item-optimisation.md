...
<figure><img src="../.gitbook/assets/image (1) (3).png" alt=""><figcaption><p>From Left to Right: A "Pick up" button (green when inventory space, red when full). A example inventory, with 2/6 empty slots. A GPS Jammer screen with a description, Jam and Drop button.</p></figcaption></figure>
