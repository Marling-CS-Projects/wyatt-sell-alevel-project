...
I discovered this issue by logging a `rendered` message to the console when the component renders. To work out the cause of these rerenders, I used the "Flamegraph" function within React Dev Tools.

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>A screenshot demostrating the React Dev Tools profiler</p></figcaption></figure>
