...
* **Item Level**: Items will have different levels depending on how powerful they are, for instance, a Level 2 GPS Jammer will last longer and have a greater range than a Level 1 GPS Jammer.
  * **Merging items**: If a player finds two items that are the same level
