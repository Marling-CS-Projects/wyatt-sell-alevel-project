...
My game will be a live multiplayer geolocation game, based off the "Hunted" TV Show, and following a manhunt style format. There would be two teams, Hunters and Hunted:
...
![Share Tech Mono (Google Fonts)](<../.gitbook/assets/image (7).png>)
...
![Photograph of Pokémon Go AR Gameplay ](<../.gitbook/assets/image (1).png>)
