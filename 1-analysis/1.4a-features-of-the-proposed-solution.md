...
When the user clicks on their backpack, a screen should appear with all your items visible. You should be able to click on each item, and buttons will popup so you are able to interact with that item.
