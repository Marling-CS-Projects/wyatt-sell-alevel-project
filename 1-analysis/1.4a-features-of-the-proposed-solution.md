...
* **Virtualised "public appeal"**: Hunters will as a team have 2 "public appeal" buttons for the entire game. In order to use them, there must be majority approval from the Hunters. This will result in location reports occurring depending on how close the person being Hunted is to a road/urban environment. The location reports are guaranteed to be accurate. There will be a significant delay before the person being Hunted is aware of their public appeal.
...
* **Foil blanket**
* **Disguise**
* **Stingray** sound gets louder if hunted is closer
