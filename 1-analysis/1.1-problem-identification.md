...
* A video game would have the potential to avoid the drawbacks and critisms of its TV show counterpart. For example, a common critism of the show, as [Adam Postan](../reference-list.md) writes is that "_About half of what it says is happening actually isn’t, from its disclaimer: “For the purposes of this series, some powers of state have been replicated, including CCTV and ANPR”._ This, as Postan goes on to say, means the more astute viewers are unable to become immersed in the show, as  it generates too many questions about how these surveillance techniques are able to be replicated.&#x20;
