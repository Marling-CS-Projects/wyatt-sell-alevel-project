...
Television viewing has long been correlated with lower levels of physical fitness, and a higher chance of being overweight ([Hancox, Milne and Poulton, 2004](../reference-list.md), [Tucker, 1986](../reference-list.md)). As discussed earlier, television viewership is highest in elderly age brackets where the risk for natural physical and functional decline is already high ([Guralnik et al., 1993](../reference-list.md))
