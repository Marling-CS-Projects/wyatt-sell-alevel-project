...
* _On the create screen, the Create button is not fully visible_: To fix this, I would style the map container to grow to fit available visible space within the viewport using CSS
...
* _When a user disconnects and reconnects_
